...
// Ambil data kehadiran dari database hanya dengan status 'terlambat'
$limit = 15; // Jumlah baris per halaman
$page = isset($_GET['page']) ? (int)$_GET['page'] : 1; // Halaman saat ini
$offset = ($page - 1) * $limit; // Offset untuk query

// Query untuk menghitung total jumlah kehadiran terlambat
$total_query = "SELECT COUNT(*) as total FROM datang WHERE TRIM(LOWER(status)) = 'terlambat'";
$total_result = $conn->query($total_query);
$total_row = $total_result->fetch_assoc();
$total_rows = $total_row['total'];
$total_pages = ceil($total_rows / $limit); // Total halaman

// Query untuk mengambil data dengan pengurutan DESC (terbaru di atas)
$query_absen = "
    ...
    ORDER BY d.tanggal ASC, d.waktu_absen DESC
    LIMIT ? OFFSET ?
";
...
<head>
    ...
    <title>Tabel Keterlambatan Guru</title>
</head>
<body style="background-color: rgb(238, 238, 238);">
    ...
    <div class="d-flex mt-3 me-4 ms-3">
        <div class="row w-100">
            ...
            <div class="col">
                <h4 style="font-weight: bold; margin: 0; padding: 0;">Data Keterlambatan</h4>
            </div>
        </div>
    </div>
